...
**Generated:** 2026-08-21 06:24:56 UTC  
...
|---|:---:|---|:---:|:---:|:---:|---|
| `exp_channel_a_hook_structure_counterfactual_question_v1` | **channel_a** | `HOOK_STRUCTURE` | $N \ge 4$ | C:0/4, T:0/4 | `PROPOSED` | FIRST_PARTY_DISCOVERY |
| `exp_channel_a_topic_cluster_modern_warfare_and_geopolitical_divergence_v1` | **channel_a** | `TOPIC_CLUSTER` | $N \ge 4$ | C:0/4, T:0/4 | `PROPOSED` | FIRST_PARTY_DISCOVERY |
| `exp_channel_b_hook_structure_socratic_question_v1` | **channel_b** | `HOOK_STRUCTURE` | $N \ge 4$ | C:0/4, T:0/4 | `PROPOSED` | FIRST_PARTY_DISCOVERY |
| `exp_channel_b_topic_cluster_ai_ethics_and_future_dilemmas_v1` | **channel_b** | `TOPIC_CLUSTER` | $N \ge 4$ | C:0/4, T:0/4 | `PROPOSED` | FIRST_PARTY_DISCOVERY |
...
- **Channel:** `channel_a` | **Status:** `PROPOSED` | **Provenance:** `SIMULATION`
...
- **Lineage Status:** `INCOMPLETE` (Pending: experiment_arms_unregistered, production_jobs_unstarted, videos_unpublished, performance_snapshots_pending, outcome_unevaluated, learning_event_unrecorded)

--------------------------------------------------

### Experiment: `exp_channel_a_topic_cluster_modern_warfare_and_geopolitical_divergence_v1`

- **Channel:** `channel_a` | **Status:** `PROPOSED` | **Provenance:** `PUBLIC_YOUTUBE`
...
- **Channel:** `channel_b` | **Status:** `PROPOSED` | **Provenance:** `PUBLIC_YOUTUBE`
