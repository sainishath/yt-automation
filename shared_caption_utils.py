# -*- coding: utf-8 -*-
"""
shared_caption_utils.py
-----------------------
Shared caption alignment and ASS file generation utilities.
Extracted from alternate-history-shorts to ensure reuse and prevent copy-paste duplication.
"""
...
def map_color_to_ass(color_name: str) -> str:
    """Map human readable colors or hex values to ASS ABGR formatting."""
    color_map = {
        "white": "&H00FFFFFF",
        "black": "&H00000000",
        "cyan": "&H00FFFF00",
...
def align_and_generate_ass(
    ...
    # Group words into natural linguistic phrases (1-4 words per chunk, keeping articles/prepositions together)
    chunks = []
    chunk = []
    chunk_chars = 0
    ...
    for word_info in aligned:
        ...
        if not chunk:
            ...
            # Force split if max_words reached, OR if char limit exceeded (unless previous word is a non-split article/preposition)
